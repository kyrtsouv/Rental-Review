...
public class RentalDialog extends JDialog {
    ...
    public RentalDialog(Frame parent, boolean modal, String name, String type, String location, String description,
        ...
        totalReviewsLabel = new JLabel(
                "<html>" + "Συνολικές Αξιολογήσεις: " + Integer.toString(totalReviews) + "</html>");
        ...
        addButton = new MyButton("Προσθήκη Αξιολόγησης");
    ...
    public void addReview(ReviewPanel review) {
        ...
        totalReviewsLabel.setText("<html>" + "Συνολικές Αξιολογήσεις: " + String.valueOf(totalReviews) + "</html>");
        ratingLabel.setText("<html>" + "Βαθμολογία: " + (float) Math.round(rating * 100) / 100 + "</html>");
        addPanel.setVisible(false);
        revalidate();
        repaint();
    }
    ...
    public void addReviews(HashMap<String, ReviewPanel> reviews) {
        ...
        totalReviewsLabel.setText("<html>" + "Συνολικές Αξιολογήσεις: " + String.valueOf(totalReviews) + "</html>");
        ratingLabel.setText(
                "<html>" + "Βαθμολογία: " + String.valueOf((float) Math.round(rating * 100) / 100) + "</html>");
        revalidate();
        repaint();
    }
