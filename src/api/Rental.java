...
public class Rental implements Serializable {
    ...
    //Η συγκεκριμένη διαδικασία υπάρχει για την αναζήτηση στοιχείων που αποθηκεύονται εδώ για την χρήση τους σε άλλες κλάσεις
    ...
    //Επίσης, παρόμοια άλλα πιο αναλυτική καθώς αφορά την αξιολόγηση ενός καταλύματος σαν σύνολο επεξεργάζοντας κάθε αξιολόγηση και υπολογίζοντας το μέσω όρό
