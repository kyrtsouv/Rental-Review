...
public class Renter {
    ...
    public void editRental(Rental rental, String name, String address, String city, String postcode, String description, String type, String owner) {
...
/*
    public void editName(String name) {details.replace("name", name);}
    public void editSurname(String surname) {details.replace("surname", surname);}
    public void editUsername(String username) {details.replace("username", username);}
    public void editPassword(String password) {details.replace("password", password);}
  */
